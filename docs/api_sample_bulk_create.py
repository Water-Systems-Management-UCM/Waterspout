...
API_TOKEN = "aee697c54e9f65c3ccf26689d312e48b7e054581"
ORGANIZATION_ID = 2  # Your organization identifies where the model runs will be placed and who they'll be available to. DSC's ID is 2
...
LAND_KEY = 0
LAND_OPTIONS = (0.5, 1.2)
WATER_KEY = 1
WATER_OPTIONS = (0.5, 1.2)
PRICE_KEY = 2
PRICE_OPTIONS = (0.8, 1.2)
YIELD_KEY = 3
YIELD_OPTIONS = (0.8, 1.2)
...
for model_options in permutations:  # loop through every possible permutation
	...
	# and 403 means you authenticated, but don't have permission. Others can mean the request was malformed) and 500-series means that the server-side had an error
	# processing the request. It may be a bad request, but is also a bug worth processing
