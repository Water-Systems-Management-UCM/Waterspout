...
EMAIL_HOST_USER = 'tapiamichael19'  # username for email sending login
EMAIL_HOST_PASSWORD = 'qsuc rssx zajy pics'  # the password for the account to send email through
