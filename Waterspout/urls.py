...
urlpatterns = [
    ...
    path('password-reset/', ws_views.GetPasswordReset.as_view(), name='password-reset'),
    path('password-reset/<str:encoded_pk>/<str:token>/', ws_views.DoPasswordReset.as_view(), name='password-reset')
]
