...
urlpatterns = [
    ...
    path('reset-password/', ws_views.GetPasswordReset.as_view(), name='password-reset'),
    path('reset-password/<str:encoded_pk>/<str:token>/', ws_views.DoPasswordReset.as_view(), name='password-reset')
]
