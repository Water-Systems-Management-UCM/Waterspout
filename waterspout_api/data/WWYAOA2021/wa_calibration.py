...
def recalibrate():
    ...
    input_data = os.path.join(current_folder, "inputdata_2021.csv")

    # use the most recent years
    calibration_years = [2021]
    ...
    calibrator.calibration_df.to_csv(os.path.join(current_folder, "calibration_data2021.csv"))
