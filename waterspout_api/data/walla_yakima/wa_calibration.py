...
def recalibrate():
    ...
    input_data = os.path.join(current_folder, "inputs-data-2024.csv")
    ...
    calibrator.calibration_df.to_csv(os.path.join(current_folder, "calibration_walla_w_yakima2024.csv"))
